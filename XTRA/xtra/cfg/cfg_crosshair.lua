...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("xtra_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("xtra_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("xtra_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("xtra_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("xtra_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("xtra_crosshair_gap")
    ...
    local red = GetResourceKvpInt("xtra_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("xtra_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("xtra_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('xtra_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('xtra_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('xtra_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('xtra_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('xtra_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('xtra_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('xtra_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('xtra_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('xtra_crosshair_green', cfg.options.colour.green)
end
