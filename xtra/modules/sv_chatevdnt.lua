...
Citizen.CreateThread(function()
    while true do
        if over then
            ...
            theString = Code
            --TriggerClientEvent('chatMessage', -1, "XTRA","^2[Mini-Event] Who writes the word: " .. theString .. " first gets £" .. theReward)
            TriggerClientEvent('chatMessage', -1, "XTRA",  { 255, 255, 255 }, "^2[Mini-Event] Who writes the word: " .. theString .. " first gets £" .. theReward,  "ooc", "OOC")
...
function HandleMoneys(user_id, theReward) 
    TriggerClientEvent('chatMessage', -1, "XTRA",  { 255, 255, 255 }, "^2[Mini-Event] " .. XTRA.GetPlayerName(user_id) .. " wrote the word and won £" .. theReward,  "ooc", "OOC")
    -- Reset Event
    theReward = 0
    theString = 0 
    over = true;
