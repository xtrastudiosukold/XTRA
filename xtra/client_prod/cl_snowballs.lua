...
function func_snowballs()
    while true do
        ...
        if IsNextWeatherType("XMAS") then
            ...
            if
                IsControlJustReleased(0, 119) and not IsPedInAnyVehicle(GetPlayerPed(-1), true) and
