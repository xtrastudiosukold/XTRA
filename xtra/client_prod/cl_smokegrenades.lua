...
local function b()
    ...
    TriggerServerEvent("XTRA:startThrowSmokeGrenade", c)
    Citizen.Wait(100)
    ...
    TriggerServerEvent("XTRA:endThrowSmokeGrenade", c, g)
end
local function h(i)
...
RegisterNetEvent(
    ...
    function(c, g)
        ...
        Citizen.Wait(60000)
        tXTRA.removeArea("smoke_" .. tostring(c))
        if l.handle then
            StopParticleFxLooped(l.handle, false)
            l.handle = nil
            l.isDeleted = true
