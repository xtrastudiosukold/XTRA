...
RP.Shared = {
    ...
    ["carryfr"] = { -- Male Custom emote by XTRA Mods
        "couplepose1fr@animation",
        "couplepose1xtra_clip",
        "Carry Me Cute 3",
        "carryfr2",
        AnimationOptions = {
            EmoteMoving = false,
    ...
    ["carryfr2"] = { -- Female Custom emote by XTRA Mods
        "couplepose2fr@animation",
        "couplepose2xtra_clip",
        "Carry Me Cute 4",
        "carryfr",
        AnimationOptions = {
            EmoteLoop = true,
...
RP.PropEmotes = {
    ...
    ["skatesit"] = { -- Custom Emote By XTRA Mods
        "skateboardposefranimation",
        "skateboardposextra_clip",
        "Skateboard - Sit",
        AnimationOptions = {
