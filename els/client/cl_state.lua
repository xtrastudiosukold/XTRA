...
RegisterNetEvent("XTRAELS:changeStage", function(netId, stage)
...
RegisterNetEvent("XTRAELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("XTRAELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("XTRAELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("XTRAELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("XTRAELS:indicatorChange", function(netId, indicator, enabled)
