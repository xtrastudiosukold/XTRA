webpackJsonp([1], [, , , , , , , , , , function(t, e, n) {
    ...
    var P = function() {
        ...
        m()(t, [{
            ...
            key: "onask_dnd",
            value: function t(e) {
                var n = window.localStorage["xtra_fivem_dnd"] || false;
                this.post("dnd", {
                    dnd: n
                });
            ...
            value: function t(e, n) {
                this.post("global_login", {
                    username: e,
                    password: n
                })
            }
        }, {
            key: "global_changePassword",
            value: function t(e, n, s) {
                this.post("global_changePassword", {
                    username: e,
                    password: n,
                    newPassword: s
                })
            ...
            key: "global_createAccount",
            value: function t(e, n, s) {
                this.post("global_createAccount", {
                    username: e,
                    password: n,
                    avatarUrl: s
                })
            ...
            key: "global_postTweet",
            value: function t(e, n, s) {
                this.post("global_postTweet", {
                    username: e,
                    password: n,
                    message: s
                })
            ...
            key: "global_postTweetImg",
            value: function t(e, n, s) {
                this.post("global_postTweetImg", {
                    username: e,
                    password: n,
                    message: s
                })
            ...
            key: "global_toggleLikeTweet",
            value: function t(e, n, s) {
                this.post("global_toggleLikeTweet", {
                    username: e,
                    password: n,
                    tweetId: s
                })
            ...
            key: "global_setAvatar",
            value: function t(e, n, s) {
                this.post("global_setAvatarUrl", {
                    username: e,
                    password: n,
                    avatarUrl: s
                })
            ...
            key: "global_getGlobals",
            value: function t(e, n) {
                this.post("global_getGlobals", {
                    username: e,
                    password: n
                })
            }
        }, {
            key: "global_getFavoriteGlobals",
            value: function t(e, n) {
                this.post("global_getFavoriteGlobals", {
                    username: e,
                    password: n
                })
            }
        }, {
            key: "onglobal_globals",
            value: function t(e) {
                w["a"].commit("SET_GLOBALS", e)
            }
        }, {
            key: "onglobal_favoriteglobals",
            value: function t(e) {
                w["a"].commit("SET_FAVORITE_GLOBALS", e)
            }
        }, {
            key: "onglobal_newTweet",
            value: function t(e) {
                w["a"].dispatch("addTweet", e.tweet)
            }
        }, {
            key: "onglobal_setAccount",
            value: function t(e) {
                w["a"].dispatch("setAccount", e)
            }
        }, {
            key: "onglobal_updateTweetLikes",
            value: function t(e) {
                w["a"].commit("UPDATE_TWEET_LIKE", e)
            }
        }, {
            key: "onglobal_setTweetLikes",
            value: function t(e) {
                w["a"].commit("UPDATE_TWEET_ISLIKE", e)
            }
        }, {
            key: "onglobal_showError",
            value: function t(e) {
                y["a"].notify({
    ...
    var v = {
        ...
        tempoHide: false,
        myPhoneNumber: "###-####",
        background: JSON.parse(window.localStorage["xtra_fivem_background"] || null),
        coque: JSON.parse(window.localStorage["xtra_fivem_coque"] || null),
        ringtone: JSON.parse(window.localStorage["xtra_fivem_ringtone"] || null),
        zoom: window.localStorage["xtra_fivem_zoom"] || "80%",
        volume: parseFloat(window.localStorage["xtra_fivem_volume"]) || 1,
        mouse: window.localStorage["xtra_fivem_mouse"] === "true",
        lang: window.localStorage["xtra_fivem_language"],
        config: {
            reseau: "EE 5G",
        ...
        dnd: window.localStorage["xtra_fivem_dnd"] || false,
        folders: [{
    ...
    var g = {
        ...
        setZoon: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_zoom"] = n;
            s("SET_ZOOM", n)
        },
        setBackground: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_background"] = r()(n);
            s("SET_BACKGROUND", n)
        },
        setCoque: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_coque"] = r()(n);
            s("SET_COQUE", n)
        },
        setringtone: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_ringtone"] = r()(n);
            s("SET_ringtone", n)
        },
        setVolume: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_volume"] = n;
            s("SET_VOLUME", n)
        },
        setLanguage: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_language"] = n;
            p["a"].prototype.$timeago.setCurrentLocale(n);
            s("SET_LANGUAGE", n)
        },
        setMouseSupport: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_mouse"] = n;
            d["a"].setUseMouse(n);
        ...
        setDND: function t(e, n) {
            var s = e.commit;
            window.localStorage["xtra_fivem_dnd"] = n;
            s("SET_DND", n);
            d["a"].dnd(n)
        },
    ...
    var _ = {
        ...
        SET_DND: function t(e, n) {
            e.dnd = n;
          //  console.log("state.dnd", e.dnd) // Removed due to it making f8 ugly
        },
    ...
    var a = n(15);
    var o = {
        globalUsername: localStorage["gcphone_global_username"],
        globalPassword: localStorage["gcphone_global_password"],
        globalAvatarUrl: localStorage["gcphone_global_avatarUrl"],
        globalNotification: localStorage["gcphone_global_notif"] ? parseInt(localStorage["gcphone_global_notif"]) : 1,
        globalNotificationSound: localStorage["gcphone_global_notif_sound"] !== "false",
        globals: [],
        favoriteGlobals: []
    };
    var c = {
        globalUsername: function t(e) {
            var n = e.globalUsername;
            return n
        },
        globalPassword: function t(e) {
            var n = e.globalPassword;
            return n
        },
        globalAvatarUrl: function t(e) {
            var n = e.globalAvatarUrl;
            return n
        },
        globalNotification: function t(e) {
            var n = e.globalNotification;
            return n
        },
        globalNotificationSound: function t(e) {
            var n = e.globalNotificationSound;
            return n
        },
        globals: function t(e) {
            var n = e.globals;
            return n
        },
        favoriteGlobals: function t(e) {
            var n = e.favoriteGlobals;
            return n
        }
    };
    var u = {
        globalCreateNewAccount: function t(e, n) {
            var s = n.username,
                r = n.password,
                a = n.avatarUrl;
            i["a"].global_createAccount(s, r, a)
        },
        globalLogin: function t(e, n) {
            var s = e.commit;
            var r = n.username,
                a = n.password;
            i["a"].global_login(r, a)
        },
        globalChangePassword: function t(e, n) {
            var s = e.state;
            i["a"].global_changePassword(s.globalUsername, s.globalPassword, n)
        },
        globalLogout: function t(e) {
            var n = e.commit;
            localStorage.removeItem("gcphone_global_username");
            localStorage.removeItem("gcphone_global_password");
            localStorage.removeItem("gcphone_global_avatarUrl");
            n("UPDATE_ACCOUNT", {
                username: undefined,
                password: undefined,
                avatarUrl: undefined
        ...
        globalSetAvatar: function t(e, n) {
            var s = e.state;
            var r = n.avatarUrl;
            i["a"].global_setAvatar(s.globalUsername, s.globalPassword, r)
        },
        globalPostTweet: function t(e, n) {
            var s = e.state,
                r = e.commit;
            var a = n.message;
            if (/^https?:\/\/.*\.(png|jpg|jpeg|gif)$/.test(a)) {
                i["a"].global_postTweetImg(s.globalUsername, s.globalPassword, a)
            } else {
                i["a"].global_postTweet(s.globalUsername, s.globalPassword, i["a"].convertEmoji(a))
            }
        },
        globalToogleLike: function t(e, n) {
            var s = e.state;
            var r = n.tweetId;
            i["a"].global_toggleLikeTweet(s.globalUsername, s.globalPassword, r)
        },
        setAccount: function t(e, n) {
            var s = e.commit;
            localStorage["gcphone_global_username"] = n.username;
            localStorage["gcphone_global_password"] = n.password;
            localStorage["gcphone_global_avatarUrl"] = n.avatarUrl;
            s("UPDATE_ACCOUNT", n)
        },
        addTweet: function t(e, n) {
            var s = e.commit,
                r = e.state;
            var i = r.globalNotification === 2;
            if (r.globalNotification === 1) {
                i = n.message && n.message.toLowerCase().indexOf(r.globalUsername.toLowerCase()) !== -1
            }
            if (i === true) {
                a["a"].notify({
                    message: n.message,
                    title: n.author + " :",
                    icon: "global",
                    sound: r.globalNotificationSound ? "Global_Sound_Effect.ogg" : undefined
                })
            }
            s("ADD_TWEET", {
                tweet: n
        ...
        fetchGlobals: function t(e) {
            var n = e.state;
            i["a"].global_getGlobals(n.globalUsername, n.globalPassword)
        },
        fetchFavoriteGlobals: function t(e) {
            var n = e.state;
            i["a"].global_getFavoriteGlobals(n.globalUsername, n.globalPassword)
        },
        setGlobalNotification: function t(e, n) {
            var s = e.commit;
            localStorage["gcphone_global_notif"] = n;
            s("SET_GLOBAL_NOTIFICATION", {
                notification: n
            })
        },
        setGlobalNotificationSound: function t(e, n) {
            var s = e.commit;
            localStorage["gcphone_global_notif_sound"] = n;
            s("SET_GLOBAL_NOTIFICATION_SOUND", {
                notificationSound: n
            })
        }
    };
    var l = {
        SET_GLOBAL_NOTIFICATION: function t(e, n) {
            var s = n.notification;
            e.globalNotification = s
        },
        SET_GLOBAL_NOTIFICATION_SOUND: function t(e, n) {
            var s = n.notificationSound;
            e.globalNotificationSound = s
        },
        ...
        SET_GLOBALS: function t(e, n) {
            var s = n.globals;
            e.globals = s
        },
        SET_FAVORITE_GLOBALS: function t(e, n) {
            var s = n.globals;
            e.favoriteGlobals = s
        },
        ADD_TWEET: function t(e, n) {
            var s = n.tweet;
            e.globals = [s].concat(r()(e.globals))
        },
        UPDATE_TWEET_LIKE: function t(e, n) {
            var s = n.tweetId,
                r = n.likes;
            var i = e.globals.findIndex(function(t) {
                return t.id === s
            });
            if (i !== -1) {
                e.globals[i].likes = r
            }
            var a = e.favoriteGlobals.findIndex(function(t) {
                return t.id === s
            });
            if (a !== -1) {
                e.favoriteGlobals[a].likes = r
            }
        },
        UPDATE_TWEET_ISLIKE: function t(e, n) {
            ...
            if (i !== -1) {
                a["a"].set(e.globals[i], "isLikes", r)
            }
            var o = e.favoriteGlobals.findIndex(function(t) {
                return t.id === s
            });
            if (o !== -1) {
                a["a"].set(e.favoriteGlobals[o], "isLikes", r)
            }
        }
    };
    e["a"] = {
    ...
    e["default"] = {
        ...
        computed: c()({}, n.i(f["b"])(["IntlString", "useMouse", "globalUsername", "globalPassword", "globalAvatarUrl", "globalNotification", "globalNotificationSound"]), {
            isLogin: function t() {
                return this.globalUsername !== undefined && this.globalUsername !== ""
            },
        ...
        methods: c()({}, n.i(f["a"])(["globalLogin", "globalChangePassword", "globalLogout", "globalSetAvatar", "globalCreateNewAccount", "setGlobalNotification", "setGlobalNotificationSound"]), {
            onUp: function t() {
                if (this.ignoreControls === true && !this.typing) return;
                var e = document.querySelector(".group.select");
                if (e === null) {
                            ...
                            switch (s.prev = s.next) {
                                case 0:
                                    ...
                                    return h["a"].CreateTextModal({
                                        text: n.globalAvatarUrl || "https://i.imgur.com/"
                                    });
                                case 3:
                                    e = s.sent;
                        ...
                        while (1) {
                            switch (s.prev = s.next) {
                                case 0:
                                    ...
                                    s.next = 3;
                                    return h["a"].CreateTextModal({
                                        text: e.globalAvatarUrl || "https://i.imgur.com/"
                                    });
                                case 3:
                                    n = s.sent;
                                    e.globalSetAvatar({
            ...
            createAccount: function t() {
                if (this.validAccount === true) {
                    this.globalCreateNewAccount(this.localAccount);
                    this.localAccount = {
                        username: "",
                        password: "",
                        passwordConfirm: "",
            ...
            setNotification: function t(e) {
                this.setGlobalNotification(e)
            },
            setNotificationSound: function t(e) {
                this.setGlobalNotificationSound(e)
            },
                        ...
                        while (1) {
                            switch (r.prev = r.next) {
                                ...
                                case 11:
                                    ...
                                    n.$notify({
                                        title: n.IntlString("APP_GLOBAL_NAME"),
                                        message: n.IntlString("APP_GLOBAL_NOTIF_NEW_PASSWORD_MISS_MATCH"),
                                        icon: "global",
                                        backgroundColor: "#e0245e80"
                                    });
                                    return r.abrupt("return");
                                case 16:
                                    ...
                                    n.$notify({
                                        title: n.IntlString("APP_GLOBAL_NAME"),
                                        message: n.IntlString("APP_GLOBAL_NOTIF_NEW_PASSWORD_LENGTH_ERROR"),
                                        icon: "global",
                                        backgroundColor: "#e0245e80"
                                    });
                                    return r.abrupt("return");
                                case 19:
                                    n.globalChangePassword(s.text);
                                    r.next = 25;
                                    break;
                                case 22:
                                    r.prev = 22;
    ...
    e["default"] = {
        ...
        watch: {},
        methods: c()({}, n.i(u["a"])(["globalPostTweet"]), {
            onEnter: function t() {
                var e = this;
                return a()(r.a.mark(function t() {
    ...
    e["default"] = {
        ...
        computed: r()({}, n.i(v["b"])(["IntlString", "useMouse"]), {
            screen: function t() {
                return [{
                    title: this.IntlString("APP_GLOBAL_VIEW_GLOBAL"),
                    component: c.a,
                    icon: "fa-home"
                }, {
                    title: this.IntlString("APP_GLOBAL_VIEW_TOP_GLOBALS"),
                    component: d.a,
                    icon: "fa-heart"
                }, {
                    title: this.IntlString("APP_GLOBAL_VIEW_TWEETER"),
                    component: l.a,
                    icon: " fa-comment-o"
                }, {
                    title: this.IntlString("APP_GLOBAL_VIEW_SETTING"),
                    component: h.a,
                    icon: "fa-cog"
                }]
            },
        ...
        created: function t() {
            ...
            this.$bus.$on("globalHome", this.home)
        },
        mounted: function t() {},
        beforeDestroy: function t() {
            this.$bus.$off("keyUpArrowLeft", this.onLeft);
            this.$bus.$off("keyUpArrowRight", this.onRight);
            this.$bus.$off("globalHome", this.home)
        }
    }
}, function(t, e, n) {
    "use strict";
    ...
    e["default"] = {
        ...
        computed: l()({}, n.i(f["b"])(["favoriteGlobals", "IntlString", "useMouse"]), {
            globals: function t() {
                return this.favoriteGlobals
            }
        }),
        watch: {},
        methods: l()({}, n.i(f["a"])(["globalLogin", "globalPostTweet", "globalToogleLike", "fetchFavoriteGlobals"]), {
            ...
            resetScroll: function t() {
                var e = this;
                this.$nextTick(function() {
                    var t = document.querySelector("#globals");
                    t.scrollTop = t.scrollHeight;
                    e.selectMessage = -1
                })
            },
            ...
            onDown: function t() {
                ...
                if (this.selectMessage === -1) {
                    ...
                    this.selectMessage = this.selectMessage === this.globals.length - 1 ? this.selectMessage : this.selectMessage + 1
                }
                this.scrollIntoViewIfNeeded()
            },
            onEnter: function t() {
    ...
    e["default"] = {
        ...
        computed: l()({}, n.i(f["b"])(["globals", "IntlString", "useMouse"])),
        watch: {},
        methods: l()({}, n.i(f["a"])(["globalLogin", "globalPostTweet", "globalToogleLike", "fetchGlobals"]), {
            showOption: function t() {
                var e = this;
                return c()(r.a.mark(function t() {
                    var n, s, i;
    ...
    t.exports = {
        ...
        staticRenderFns: [function() {
            ...
            return n("div", {
                ...
                attrs: {
                    src: "/html/static/img/global/bird.png"
                }
            })])
        }]
    }
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                ref: "elementsDiv",
                staticClass: "globals-wrapper"
            }, t._l(t.globals, function(e, s) {
                return n("div", {
                    key: e.id,
                    staticClass: "tweet",
                    class: {
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                attrs: {
                    type: "button",
                    value: t.IntlString("APP_GLOBAL_NOTIFICATION")
                },
                on: {
                    click: function(e) {
                        e.stopPropagation();
                ...
                attrs: {
                    type: "button",
                    value: t.IntlString("APP_GLOBAL_ACCOUNT_PARAM")
                },
                on: {
                    click: function(e) {
                        e.stopPropagation();
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v(t._s(t.IntlString("APP_GLOBAL_ACCOUNT_USERNAME")))])]), t._v(" "), n("div", {
                staticClass: "group inputText",
                attrs: {
                    "data-type": "text",
                    "data-model": "password",
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v(t._s(t.IntlString("APP_GLOBAL_ACCOUNT_PASSWORD")))])]), t._v(" "), n("div", {
                staticClass: "group",
                attrs: {
                    "data-type": "button"
                },
                ...
                attrs: {
                    type: "button",
                    value: t.IntlString("APP_GLOBAL_ACCOUNT_LOGIN")
                },
                on: {
                    click: function(e) {
                        e.stopPropagation();
            ...
            }, [n("label", [t._v(t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_WHEN")))])]), t._v(" "), n("label", {
                ...
                domProps: {
                    checked: t.globalNotification === 2
                },
                on: {
                    click: function(e) {
                        e.preventDefault();
            ...
            }), t._v("\n      " + t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_ALL")) + "\n    ")]), t._v(" "), n("label", {
                staticClass: "group checkbox",
                attrs: {
                    "data-type": "button"
                },
                ...
                domProps: {
                    checked: t.globalNotification === 1
                },
                on: {
                    click: function(e) {
                        e.preventDefault();
            ...
            }), t._v("\n      " + t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_MENTION")) + "\n    ")]), t._v(" "), n("label", {
                staticClass: "group checkbox",
                attrs: {
                    "data-type": "button"
                },
                ...
                domProps: {
                    checked: t.globalNotification === 0
                },
                on: {
                    click: function(e) {
                        e.preventDefault();
            ...
            }), t._v("\n      " + t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_NEVER")) + "\n    ")]), t._v(" "), n("div", {
                staticClass: "groupCheckBoxTitle"
            }, [n("label", [t._v(t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_SOUND")))])]), t._v(" "), n("label", {
                staticClass: "group checkbox",
                attrs: {
                    "data-type": "button"
                },
                ...
                domProps: {
                    checked: t.globalNotificationSound
                },
                on: {
                    click: function(e) {
                        e.preventDefault();
            ...
            }), t._v("\n      " + t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_SOUND_YES")) + "\n    ")]), t._v(" "), n("label", {
                staticClass: "group checkbox",
                attrs: {
                    "data-type": "button"
                },
            ...
            }), t._v("\n      " + t._s(t.IntlString("APP_GLOBAL_NOTIFICATION_SOUND_NO")) + "\n    ")])] : t.state === t.STATES.ACCOUNT ? [n("img", {
                staticStyle: {
                    "align-self": "center"
                },
                attrs: {
                ...
                attrs: {
                    type: "button",
                    value: t.IntlString("APP_GLOBAL_ACCOUNT_AVATAR")
                },
                on: {
                    click: function(e) {
                        e.stopPropagation();
                ...
                attrs: {
                    type: "button",
                    value: t.IntlString("APP_GLOBAL_ACCOUNT_AVATAR_TAKE")
                },
                on: {
                    click: function(e) {
                        e.stopPropagation();
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "global_menu"
            }, t._l(t.screen, function(e, s) {
                return n("div", {
                    key: s,
                    staticClass: "global_menu-item",
                    class: {
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "elements"
            }, [n("center", [n("div", [t._v("Coming Soon to XTRA")])])], 1)], 1)
        },
        staticRenderFns: []
    }
}, function(t, e) {
